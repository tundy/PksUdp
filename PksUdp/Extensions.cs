...
namespace PksUdp
{
    internal static class Extensions
    {
        ...
        public static bool CompareChecksum(this byte[] data, short crc)
            => (data[data.Length - 2] == (byte) crc) && (data[data.Length - 3] == (byte) (crc >> 8));
        ...
        public static uint GetFragmentOrder(this byte[] data)
            =>
            (uint)
            ((data[FragmentOrderIndex] << 24) | (data[FragmentOrderIndex + 1] << 16) |
             (data[FragmentOrderIndex + 2] << 8) | data[FragmentOrderIndex + 3]);
        ...
        public static uint GetFragmentCount(this byte[] data)
            =>
            (uint)
            ((data[FragmentCountIndex] << 24) | (data[FragmentCountIndex + 1] << 16) |
             (data[FragmentCountIndex + 2] << 8) | data[FragmentCountIndex + 3]);
